...
# Now, import the PowerForecaster class from src.power_forecaster
...
def main_demo():
    ...
    forecaster = PowerForecaster(data_dir=os.path.join(project_root, 'inputs'), output_dir=os.path.join(project_root, 'outputs'))
